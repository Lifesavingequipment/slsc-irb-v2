-- Fix: sender_id in chat_messages references members.id, not auth.users.id.
-- Earlier version used auth_user_id = NEW.sender_id which never matched.
-- Redundant CREATE OR REPLACE — final version consolidated here.
